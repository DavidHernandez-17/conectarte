<x-wireui:card class="shadow-xl">
  <div class="flex items-center gap-3 mb-3">
    <x-wireui:avatar lg src="{{ $post['user']['photo'] }}" />
    <div>
  ...
  <div class="flex items-center justify-between text-sm text-gray-600">
    <div class="flex gap-1">
      <a href="#"
        ...
        <x-wireui:icon name="hand-thumb-up" class="w-4 h-4" />
        Me gusta
      </a>

      <a href="#"
        class="inline-flex items-center gap-1 px-2 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200 transition">
        <x-wireui:icon name="arrow-top-right-on-square" class="w-4 h-4" />
        Contactar
      </a>
    </div>
    <x-wireui:badge outline   class="p-2" label="{{ $post['views'] }} visualizaciones" />
  </div>
</x-wireui:card>